...
bridgeFront.src = 'https://res.cloudinary.com/active-bridge/image/upload/c_scale,w_1500/v1447072193/bridge_front_ncgkbi.png'

bridgeBack = new Image
bridgeBack.onload = loadImg
bridgeBack.src = 'https://res.cloudinary.com/active-bridge/image/upload/c_scale,w_3000/v1447072443/bridge_back_uaxnrh.png'

cloudBeforeSecondGate2 = new Image
cloudBeforeSecondGate2.onload = loadImg
cloudBeforeSecondGate2.src = 'https://res.cloudinary.com/active-bridge/image/upload/c_scale,w_960/v1447072609/cloud_before_second_gate2_fbma0m.png'

cloudBeforeSecondGate1 = new Image
cloudBeforeSecondGate1.onload = loadImg
cloudBeforeSecondGate1.src = 'https://res.cloudinary.com/active-bridge/image/upload/c_scale,w_960/v1447072562/cloud_before_second_gate1_byxhde.png'

hills = new Image
hills.onload = loadImg
hills.src = 'https://res.cloudinary.com/active-bridge/image/upload/c_scale,w_960/v1447072722/hills_jhicrj.jpg'
